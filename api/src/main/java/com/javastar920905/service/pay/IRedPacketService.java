...
public interface IRedPacketService extends IBaseService {
  ...
  String REDIS_KEY_RED_PACKET_SUFFIX_QUEUE_RESULT = ":queue:result";
   ...
   * @return
   */
  default byte[] getRedPacketQueueResultKey(String redPacketId) {
    return (REDIS_KEY_RED_PACKET_PREFIX + redPacketId + REDIS_KEY_RED_PACKET_SUFFIX_QUEUE_RESULT)
        .getBytes();
  }
   ...
   * @return
   */
  JSONObject bookingRedPacket2WithDoubleQuque(String openId, String nickName, String redPacketId);
