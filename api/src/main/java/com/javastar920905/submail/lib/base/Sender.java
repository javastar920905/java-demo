...
import com.javastar920905.submail.lib.Mail;
import com.javastar920905.submail.lib.Message;
import com.javastar920905.submail.utils.RequestEncoder;
...
public class Sender implements ISender {
  ...
  protected static final String API_HOST = "https://api.mysubmail.com";
  protected static final Logger LOGGER = LoggerFactory.getLogger(Sender.class);
  private static final String API_TIMESTAMP = API_HOST+"/service/timestamp.json";
  ...
  /**
   * When the {@link AppConfig#setSignType(String)} is not normal,create a signature with sign type.
   * 
  ...
  protected HttpEntity build(Map<String, Object> data) {
    ...
    builder
        .addTextBody(SIGNATURE, createSignature(RequestEncoder.formatRequest(data)), contentType);
