package com.javastar920905.spider.page;
...
/**
 * @author ouzhx on 2018/4/11. 1: 保存获取到的响应的相关内容; 参考文档:
 *         https://www.cnblogs.com/sanmubird/p/7857474.html
 */
public class Page {
  private static final String defautCharset = Charset.defaultCharset().name();
