...
/**
 * 
 * 功能演示地址 : http://ai.baidu.com/tech/speech/tts
 * 
 * @author ouzhx on 2018/3/1. 百度语音合成demo sdk文档http://ai.baidu.com/docs#/TTS-Online-Java-SDK/top
 *         (当前版本 4.1.1)
 *
 * 
 */
public class VoiceCombine {
  ...
  /**
   * 登录个人控制台获取apikey https://console.bce.baidu.com/ai/?_=1525678181832&fromai=1#/ai/speech/app/list
   **/
  public static final String API_KEY = "4IEohQpqktUtH1d3bdGvSUaj";
  public static final String SECRET_KEY = "TsihSOKn2Ztq9s5u0zWCi3tafpbGMCOd";
  ...
  public static AipSpeech getAipSpeech() {
    ...
    /*
     * // 可选：设置代理服务器地址, http和socket二选一，或者均不设置 client.setHttpProxy("proxy_host", proxy_port); //
     * 设置http代理 client.setSocketProxy("proxy_host", proxy_port); // 设置socket代理
     */
  ...
  /**
   * 语音合成 接口描述 基于该接口，开发者可以轻松的获取语音合成能力
   * <p>
