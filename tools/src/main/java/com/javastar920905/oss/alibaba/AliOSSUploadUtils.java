...
public class AliOSSUploadUtils {
  ...
  public static void uploadFile(String path, byte[] bytes) {
    AliOSSConstants.ossClient.putObject(bucketName, path, new ByteArrayInputStream(bytes));
  }
   ...
   */
  public static void uploadFile(String path, InputStream inputStream) {
    AliOSSConstants.ossClient.putObject(bucketName, path, inputStream);
  }
   ...
   */
  public static void uploadFile(String path, FileInputStream inputStream) {
    AliOSSConstants.ossClient.putObject(bucketName, path, inputStream);
  }
   ...
   */
  public static void uploadFile(String path, File localFile) {
    AliOSSConstants.ossClient.putObject(bucketName, path, localFile);
  }
}
