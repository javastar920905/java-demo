...
public class SpringMailSender {
  ...
  static {
    //TODO  设置为企业邮箱和发件人信息
    /*mailSender.setHost(PropertiesUtil.getProperty("email.smtp.host", ""));
    mailSender.setUsername(PropertiesUtil.getProperty("email.username.noreply", ""));
    mailSender.setPassword(PropertiesUtil.getProperty("email.password.noreply", ""));*/
  }
   ...
   *
   */
  public static void simpleSend(String to, String subject, String content) {
   ...
   *
   */
  public static void sendAttach(String to, String subject, String content, String fileName,
  ...
  private static void setMailTo(MimeMessageHelper messageHelper, String[] to) {
    try {
      messageHelper.setTo(to);
